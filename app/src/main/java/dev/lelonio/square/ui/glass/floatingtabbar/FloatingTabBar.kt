...
import dev.lelonio.square.ui.glass.glassResolutionScale
...
import dev.lelonio.square.ui.glass.backdrop.catalog.utils.DampedDragAnimation
import dev.lelonio.square.ui.glass.backdrop.catalog.utils.InteractiveHighlight
 ...
 */
val LocalTabBarBackdropFrozen = staticCompositionLocalOf<() -> Boolean> { { false } }
...
class FloatingTabBarScrollConnection(
    ...
    override fun onPreScroll(available: Offset, source: NestedScrollSource): Offset {
        ...
        if (inlineBehavior == FloatingTabBarInlineBehavior.Never || locked) {
            return Offset.Zero
        }
...
private fun SharedTransitionScope.ExpandedTabs(
    ...
    Box(modifier.width(with(density) { totalWidthPx.toDp() })) {
        ...
        // asks during draw.
        val tabBarFrozen = LocalTabBarBackdropFrozen.current
